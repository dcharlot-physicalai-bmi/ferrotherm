...
| **ferrotherm** | **1996 tests**, of which **439** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
thermodynamic computing. 19 external sources of truth, 439 verification-bearing tests, seven
machine-checked theorems, and the field's only calibrated error bars. 19 external sources, 439
verification-bearing tests of 1996 — and `scripts/check-counts.sh` derives all four figures from the
