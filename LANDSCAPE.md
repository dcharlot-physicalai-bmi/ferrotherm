...
| **ferrotherm** | **2019 tests**, of which **444** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
verification-bearing tests of 2019 — and `scripts/check-counts.sh` derives all four figures from the
