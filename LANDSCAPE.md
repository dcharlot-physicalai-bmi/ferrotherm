...
| **ferrotherm** | **2008 tests**, of which **444** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
verification-bearing tests of 2008 — and `scripts/check-counts.sh` derives all four figures from the
