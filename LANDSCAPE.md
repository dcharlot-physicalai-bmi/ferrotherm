...
| **ferrotherm** | **2015 tests**, of which **444** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
verification-bearing tests of 2015 — and `scripts/check-counts.sh` derives all four figures from the
