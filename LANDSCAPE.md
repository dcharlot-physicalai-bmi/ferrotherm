...
| **ferrotherm** | **2084 tests**, of which **457** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
thermodynamic computing. 19 external sources of truth, 457 verification-bearing tests, seven
machine-checked theorems, and the field's only calibrated error bars. 19 external sources, 457
verification-bearing tests of 2084 — and `scripts/check-counts.sh` derives all four figures from the
