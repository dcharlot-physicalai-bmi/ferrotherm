...
| **ferrotherm** | **2036 tests**, of which **448** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
verification-bearing tests of 2036 — and `scripts/check-counts.sh` derives all four figures from the
