...
| **ferrotherm** | **2057 tests**, of which **450** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
verification-bearing tests of 2057 — and `scripts/check-counts.sh` derives all four figures from the
