...
| **ferrotherm** | **2050 tests**, of which **449** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
verification-bearing tests of 2050 — and `scripts/check-counts.sh` derives all four figures from the
