...
| **ferrotherm** | **2059 tests**, of which **450** name an exact, closed-form, quadrature, oracle or enumeration comparison | the field's known answers |
...
verification-bearing tests of 2059 — and `scripts/check-counts.sh` derives all four figures from the
