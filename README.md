...
- `cargo test --workspace` — 2070 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 454 of the 2070 tests compare against an exact answer
