...
- `cargo test --workspace` — 2053 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 449 of the 2053 tests compare against an exact answer
