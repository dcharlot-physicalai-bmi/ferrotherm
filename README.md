...
- `cargo test --workspace` — 2025 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 446 of the 2025 tests compare against an exact answer
