...
- `cargo test --workspace` — 1992 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 435 of the 1992 tests compare against an exact answer
