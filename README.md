...
- `cargo test --workspace` — 2004 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 443 of the 2004 tests compare against an exact answer
