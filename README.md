...
- `cargo test --workspace` — 1999 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 441 of the 1999 tests compare against an exact answer
