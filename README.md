...
- `cargo test --workspace` — 2008 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 444 of the 2008 tests compare against an exact answer
