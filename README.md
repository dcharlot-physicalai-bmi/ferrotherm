...
- `cargo test --workspace` — 2056 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 450 of the 2056 tests compare against an exact answer
