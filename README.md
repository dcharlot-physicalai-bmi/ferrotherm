...
- `cargo test --workspace` — 2076 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 455 of the 2076 tests compare against an exact answer
