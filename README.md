...
- `cargo test --workspace` — 1996 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 439 of the 1996 tests compare against an exact answer
