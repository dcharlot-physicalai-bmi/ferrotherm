...
- `cargo test --workspace` — 2057 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 450 of the 2057 tests compare against an exact answer
