...
- `cargo test --workspace` — 1989 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 434 of the 1989 tests compare against an exact answer
