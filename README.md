...
- `cargo test --workspace` — 1995 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 438 of the 1995 tests compare against an exact answer
