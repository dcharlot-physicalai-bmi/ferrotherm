...
- `cargo test --workspace` — 2032 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 447 of the 2032 tests compare against an exact answer
