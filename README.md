...
- `cargo test --workspace` — 1997 tests across the six crates, including: exact-Boltzmann TV on an
...
Landauer, Jarzynski and `busclique` — and 440 of the 1997 tests compare against an exact answer
