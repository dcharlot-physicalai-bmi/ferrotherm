...
pub const struct_ft_sim = opaque {
    pub const ft_sweep = __root.ft_sweep;
    pub const ft_anneal = __root.ft_anneal;
    pub const ft_set_beta = __root.ft_set_beta;
    pub const ft_len = __root.ft_len;
    pub const ft_nodes = __root.ft_nodes;
    pub const ft_spins = __root.ft_spins;
    pub const ft_energy = __root.ft_energy;
    pub const ft_magnetization = __root.ft_magnetization;
    pub const ft_ledger_updates = __root.ft_ledger_updates;
    pub const ft_ledger_joules_z1 = __root.ft_ledger_joules_z1;
    pub const ft_ground_energy = __root.ft_ground_energy;
    pub const ft_certify = __root.ft_certify;
    pub const ft_cert_beta_eff = __root.ft_cert_beta_eff;
    pub const ft_cert_beta_lo = __root.ft_cert_beta_lo;
    pub const ft_cert_beta_hi = __root.ft_cert_beta_hi;
    pub const ft_cert_tau = __root.ft_cert_tau;
    pub const ft_cert_ess = __root.ft_cert_ess;
    pub const ft_cert_tv = __root.ft_cert_tv;
    pub const ft_cert_floor = __root.ft_cert_floor;
    pub const ft_cert_passed = __root.ft_cert_passed;
    pub const ft_cert_findings = __root.ft_cert_findings;
    pub const ft_cert_finding = __root.ft_cert_finding;
    pub const ft_exact_ground = __root.ft_exact_ground;
    pub const ft_exact_log_z = __root.ft_exact_log_z;
    pub const ft_exact_ground_state = __root.ft_exact_ground_state;
    pub const ft_exact_width = __root.ft_exact_width;
    pub const ft_free = __root.ft_free;
    pub const sweep = __root.ft_sweep;
    pub const anneal = __root.ft_anneal;
    pub const beta = __root.ft_set_beta;
    pub const len = __root.ft_len;
    pub const nodes = __root.ft_nodes;
    pub const spins = __root.ft_spins;
    pub const energy = __root.ft_energy;
    pub const magnetization = __root.ft_magnetization;
    pub const updates = __root.ft_ledger_updates;
    pub const z1 = __root.ft_ledger_joules_z1;
    pub const certify = __root.ft_certify;
    pub const eff = __root.ft_cert_beta_eff;
    pub const lo = __root.ft_cert_beta_lo;
    pub const hi = __root.ft_cert_beta_hi;
    pub const tau = __root.ft_cert_tau;
    pub const ess = __root.ft_cert_ess;
    pub const tv = __root.ft_cert_tv;
    pub const floor = __root.ft_cert_floor;
    pub const passed = __root.ft_cert_passed;
    pub const findings = __root.ft_cert_findings;
    pub const finding = __root.ft_cert_finding;
    pub const ground = __root.ft_exact_ground;
    pub const z = __root.ft_exact_log_z;
    pub const state = __root.ft_exact_ground_state;
    pub const width = __root.ft_exact_width;
    pub const free = __root.ft_free;
};
pub const ft_sim = struct_ft_sim;
pub const struct_ft_builder = opaque {
    pub const ft_builder_couple = __root.ft_builder_couple;
    pub const ft_builder_bias = __root.ft_builder_bias;
    pub const ft_builder_build = __root.ft_builder_build;
    pub const ft_builder_free = __root.ft_builder_free;
    pub const couple = __root.ft_builder_couple;
    pub const bias = __root.ft_builder_bias;
    pub const build = __root.ft_builder_build;
    pub const free = __root.ft_builder_free;
};
pub const ft_builder = struct_ft_builder;
pub extern fn ft_ising2d_new(l: u32, j: f64, beta: f64, seed: u64) ?*ft_sim;
pub extern fn ft_z1_new(w: u32, h: u32, j: f64, hb: f64, beta: f64, seed: u64) ?*ft_sim;
pub extern fn ft_builder_new(n: u32) ?*ft_builder;
pub extern fn ft_builder_couple(b: ?*ft_builder, i: u32, j: u32, w: f64) u32;
pub extern fn ft_builder_bias(b: ?*ft_builder, i: u32, h: f64) u32;
pub extern fn ft_builder_build(b: ?*ft_builder, beta: f64, seed: u64) ?*ft_sim;
pub extern fn ft_builder_free(b: ?*ft_builder) void;
pub extern fn ft_sweep(sim: ?*ft_sim, n: u32) u64;
pub extern fn ft_anneal(sim: ?*ft_sim, beta_min: f64, beta_max: f64, stages: u32, sweeps_per_stage: u32) f64;
pub extern fn ft_set_beta(sim: ?*ft_sim, beta: f64) void;
pub extern fn ft_len(sim: ?*const ft_sim) u32;
pub extern fn ft_nodes(sim: ?*const ft_sim) u32;
pub extern fn ft_spins(sim: ?*const ft_sim) [*c]const i8;
pub extern fn ft_energy(sim: ?*const ft_sim) f64;
pub extern fn ft_magnetization(sim: ?*const ft_sim) f64;
pub extern fn ft_ledger_updates(sim: ?*const ft_sim) u64;
pub extern fn ft_ledger_joules_z1(sim: ?*const ft_sim) f64;
pub extern fn ft_planted_frustrated(l: u32, loops: u32, seed: u64, beta: f64) ?*ft_sim;
pub extern fn ft_planted_wishart(n: u32, alpha: f64, seed: u64, beta: f64) ?*ft_sim;
pub extern fn ft_ground_energy(sim: ?*const ft_sim) f64;
pub extern fn ft_certify(sim: ?*ft_sim, draws: u32, thin: u32) u32;
pub extern fn ft_cert_beta_eff(sim: ?*const ft_sim) f64;
pub extern fn ft_cert_beta_lo(sim: ?*const ft_sim) f64;
pub extern fn ft_cert_beta_hi(sim: ?*const ft_sim) f64;
pub extern fn ft_cert_tau(sim: ?*const ft_sim) f64;
pub extern fn ft_cert_ess(sim: ?*const ft_sim) f64;
pub extern fn ft_cert_tv(sim: ?*const ft_sim) f64;
pub extern fn ft_cert_floor(sim: ?*const ft_sim) f64;
pub extern fn ft_cert_passed(sim: ?*const ft_sim) u32;
pub extern fn ft_cert_findings(sim: ?*const ft_sim) u32;
pub extern fn ft_cert_finding(sim: ?*const ft_sim, i: u32, buf: [*c]u8, cap: u32) u32;
pub extern fn ft_exact_ground(sim: ?*const ft_sim, max_width: u32) f64;
pub extern fn ft_exact_log_z(sim: ?*const ft_sim, beta: f64, max_width: u32) f64;
pub extern fn ft_exact_ground_state(sim: ?*const ft_sim, max_width: u32, out: [*c]i8, len: u32) u32;
pub extern fn ft_exact_width(sim: ?*const ft_sim) u32;
pub const struct_ft_model = opaque {
    pub const ft_model_free = __root.ft_model_free;
    pub const ft_model_categorical = __root.ft_model_categorical;
    pub const ft_model_integer = __root.ft_model_integer;
    pub const ft_model_binary = __root.ft_model_binary;
    pub const ft_model_name = __root.ft_model_name;
    pub const ft_model_not_equal = __root.ft_model_not_equal;
    pub const ft_model_equal = __root.ft_model_equal;
    pub const ft_model_fix = __root.ft_model_fix;
    pub const ft_model_cardinality = __root.ft_model_cardinality;
    pub const ft_model_at_most = __root.ft_model_at_most;
    pub const ft_model_at_least = __root.ft_model_at_least;
    pub const ft_model_lits_clear = __root.ft_model_lits_clear;
    pub const ft_model_lit = __root.ft_model_lit;
    pub const ft_model_lits = __root.ft_model_lits;
    pub const ft_model_close = __root.ft_model_close;
    pub const ft_model_objective_term = __root.ft_model_objective_term;
    pub const ft_model_objective_pair = __root.ft_model_objective_pair;
    pub const ft_model_objective_product = __root.ft_model_objective_product;
    pub const ft_model_compile = __root.ft_model_compile;
    pub const ft_model_solve = __root.ft_model_solve;
    pub const ft_model_solve_with = __root.ft_model_solve_with;
    pub const ft_model_value = __root.ft_model_value;
    pub const ft_model_feasible = __root.ft_model_feasible;
    pub const ft_model_ancillas = __root.ft_model_ancillas;
    pub const ft_model_violations = __root.ft_model_violations;
    pub const ft_model_violation = __root.ft_model_violation;
    pub const ft_model_energy = __root.ft_model_energy;
    pub const ft_model_penalty = __root.ft_model_penalty;
    pub const ft_model_fixed_penalty = __root.ft_model_fixed_penalty;
    pub const ft_model_error = __root.ft_model_error;
    pub const ft_model_ftp = __root.ft_model_ftp;
    pub const ft_model_certify = __root.ft_model_certify;
    pub const ft_model_cert_findings = __root.ft_model_cert_findings;
    pub const ft_model_cert_finding = __root.ft_model_cert_finding;
    pub const ft_model_cert_beta = __root.ft_model_cert_beta;
    pub const ft_model_cert_ess = __root.ft_model_cert_ess;
    pub const ft_model_cert_tau = __root.ft_model_cert_tau;
    pub const ft_model_cert_tv = __root.ft_model_cert_tv;
    pub const ft_model_cert_floor = __root.ft_model_cert_floor;
    pub const free = __root.ft_model_free;
    pub const categorical = __root.ft_model_categorical;
    pub const integer = __root.ft_model_integer;
    pub const binary = __root.ft_model_binary;
    pub const name = __root.ft_model_name;
    pub const not_equal = __root.ft_model_not_equal;
    pub const equal = __root.ft_model_equal;
    pub const fix = __root.ft_model_fix;
    pub const cardinality = __root.ft_model_cardinality;
    pub const at_most = __root.ft_model_at_most;
    pub const at_least = __root.ft_model_at_least;
    pub const lits_clear = __root.ft_model_lits_clear;
    pub const lit = __root.ft_model_lit;
    pub const lits = __root.ft_model_lits;
    pub const close = __root.ft_model_close;
    pub const objective_term = __root.ft_model_objective_term;
    pub const objective_pair = __root.ft_model_objective_pair;
    pub const objective_product = __root.ft_model_objective_product;
    pub const compile = __root.ft_model_compile;
    pub const solve = __root.ft_model_solve;
    pub const solve_with = __root.ft_model_solve_with;
    pub const value = __root.ft_model_value;
    pub const feasible = __root.ft_model_feasible;
    pub const ancillas = __root.ft_model_ancillas;
    pub const violations = __root.ft_model_violations;
    pub const violation = __root.ft_model_violation;
    pub const energy = __root.ft_model_energy;
    pub const penalty = __root.ft_model_penalty;
    pub const fixed_penalty = __root.ft_model_fixed_penalty;
    pub const @"error" = __root.ft_model_error;
    pub const ftp = __root.ft_model_ftp;
    pub const certify = __root.ft_model_certify;
    pub const cert_findings = __root.ft_model_cert_findings;
    pub const cert_finding = __root.ft_model_cert_finding;
    pub const cert_beta = __root.ft_model_cert_beta;
    pub const cert_ess = __root.ft_model_cert_ess;
    pub const cert_tau = __root.ft_model_cert_tau;
    pub const cert_tv = __root.ft_model_cert_tv;
    pub const cert_floor = __root.ft_model_cert_floor;
};
pub const ft_model = struct_ft_model;
pub extern fn ft_model_new() ?*ft_model;
pub extern fn ft_model_free(m: ?*ft_model) void;
pub extern fn ft_model_categorical(m: ?*ft_model, values: u32) u32;
pub extern fn ft_model_integer(m: ?*ft_model, lo: i64, hi: i64) u32;
pub extern fn ft_model_binary(m: ?*ft_model) u32;
pub extern fn ft_model_name(m: ?*ft_model, v: u32, name: [*c]const u8, len: u32) u32;
pub extern fn ft_model_not_equal(m: ?*ft_model, a: u32, b: u32) u32;
pub extern fn ft_model_equal(m: ?*ft_model, a: u32, b: u32) u32;
pub extern fn ft_model_fix(m: ?*ft_model, v: u32, value: i64) u32;
pub extern fn ft_model_cardinality(m: ?*ft_model, count: u32, k: u32, value: i64, a: u32, b: u32, c: u32, d: u32) u32;
pub extern fn ft_model_at_most(m: ?*ft_model, count: u32, k: u32, value: i64, a: u32, b: u32, c: u32, d: u32) u32;
pub extern fn ft_model_at_least(m: ?*ft_model, count: u32, k: u32, value: i64, a: u32, b: u32, c: u32, d: u32) u32;
pub extern fn ft_model_lits_clear(m: ?*ft_model) u32;
pub extern fn ft_model_lit(m: ?*ft_model, @"var": u32, value: i64) u32;
pub extern fn ft_model_lits(m: ?*const ft_model) u32;
pub extern fn ft_model_close(m: ?*ft_model, kind: u32, k: u32) u32;
pub extern fn ft_model_objective_term(m: ?*ft_model, maximize: u32, coeff: f64, v: u32, value: i64) u32;
pub extern fn ft_model_objective_pair(m: ?*ft_model, maximize: u32, coeff: f64, a: u32, av: i64, b: u32, bv: i64) u32;
pub extern fn ft_model_objective_product(m: ?*ft_model, maximize: u32, coeff: f64) u32;
pub extern fn ft_model_compile(m: ?*ft_model) u32;
pub extern fn ft_model_solve(m: ?*ft_model, tries: u32) u32;
pub extern fn ft_model_solve_with(m: ?*ft_model, tries: u32, beta0: f64, beta1: f64, stages: u32, sweeps: u32) u32;
pub extern fn ft_model_value(m: ?*const ft_model, v: u32) i64;
pub extern fn ft_model_feasible(m: ?*const ft_model) u32;
pub extern fn ft_model_ancillas(m: ?*const ft_model) u32;
pub extern fn ft_model_violations(m: ?*const ft_model) u32;
pub extern fn ft_model_violation(m: ?*const ft_model, i: u32, buf: [*c]u8, cap: u32) u32;
pub extern fn ft_model_energy(m: ?*const ft_model) f64;
pub extern fn ft_model_penalty(m: ?*const ft_model) f64;
pub extern fn ft_model_fixed_penalty(m: ?*ft_model, p: f64) u32;
pub extern fn ft_model_error(m: ?*const ft_model, buf: [*c]u8, cap: u32) u32;
pub extern fn ft_model_ftp(m: ?*const ft_model, buf: [*c]u8, cap: u32) u32;
pub extern fn ft_model_certify(m: ?*ft_model, beta: f64, draws: u32, thin: u32) u32;
pub extern fn ft_model_cert_findings(m: ?*const ft_model) u32;
pub extern fn ft_model_cert_finding(m: ?*const ft_model, i: u32, buf: [*c]u8, cap: u32) u32;
pub extern fn ft_model_cert_beta(m: ?*const ft_model) f64;
pub extern fn ft_model_cert_ess(m: ?*const ft_model) f64;
pub extern fn ft_model_cert_tau(m: ?*const ft_model) f64;
pub extern fn ft_model_cert_tv(m: ?*const ft_model) f64;
pub extern fn ft_model_cert_floor(m: ?*const ft_model) f64;
pub extern fn ft_onsager(beta: f64) f64;
pub extern fn ft_free(sim: ?*ft_sim) void;
...
pub const __deprecated_msg = @compileError("unable to translate macro: undefined identifier `__deprecated__`"); // /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.5.sdk/usr/include/sys/cdefs.h:229:10
