    ...
    Json::Arr(vec![
        ...
        tool(
            ...
            "State a constraint or optimisation problem in its own vocabulary and get NAMED VALUES \
             ...
             infeasible; \"soft_cost\" totals what those trades cost.",
            vec![
